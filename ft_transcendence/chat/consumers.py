...
class ChatConsumer(AsyncWebsocketConsumer):
    ...
    async def receive(self, text_data=None, bytes_data=None):
        ...
        # TODO: Talvez fazer assim pra no chat_message
        # pra gente conseguir enviar a chave de "chat_id" pro front
        await self.channel_layer.group_send(chat_id, {"type": "chat.message", "chat_id": chat_id, "message": message})
